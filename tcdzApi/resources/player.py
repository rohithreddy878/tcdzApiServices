...
class PlayerCareerStatsResource(Resource):
    ...
    def get(self, playerId):
        ...
        stats['3wHauls'] = self.getQueryResultForPlayerStatTwoParams(Constants.BOWLER_LANDMARK_WICKETS_QUERY, playerId,
                                                                     3)
        stats['4wHauls'] = self.getQueryResultForPlayerStatTwoParams(Constants.BOWLER_LANDMARK_WICKETS_QUERY, playerId,
                                                                     4)
